...
public class ComponentInsertedIntoSystemReaction extends AbstractReaction {
  private InsertEReference<EObject> insertChange;

  public ComponentInsertedIntoSystemReaction(final Function<ReactionExecutionState, RoutinesFacade> routinesFacadeGenerator) {
  ...
  private static class Call extends AbstractRoutine.Update {
    ...
    public void updateModels(final InsertEReference insertChange, final tools.vitruv.methodologisttemplate.model.model.System affectedEObject, final EReference affectedFeature, final Component newValue, final int index, @Extension final Model2Model2RoutinesFacade _routinesFacade) {
      _routinesFacade.createAndInsertEntity(affectedEObject, newValue);
    }
  }
  ...
  public void executeReaction(final EChange change, final ReactionExecutionState executionState, final RoutinesFacade routinesFacadeUntyped) {
    ...
    new mir.reactions.model2Model2.ComponentInsertedIntoSystemReaction.Call(executionState).updateModels(insertChange, affectedEObject, affectedFeature, newValue, index, routinesFacade);
  }
}

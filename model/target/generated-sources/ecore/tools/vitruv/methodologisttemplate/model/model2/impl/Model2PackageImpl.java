...
public class Model2PackageImpl extends EPackageImpl implements Model2Package
{
	...
	public static Model2Package init()
	{
		...
		Model2PackageImpl theModel2Package = registeredModel2Package instanceof Model2PackageImpl ? (Model2PackageImpl)registeredModel2Package : new Model2PackageImpl();
	 ...
	 */
	@Override
	public EReference getLink_Entitys()
	{
	...
	public void createPackageContents()
	{
		...
		createEReference(linkEClass, LINK__ENTITYS);
	}
	...
	public void initializePackageContents()
	{
		...
		initEReference(getLink_Entitys(), this.getEntity(), null, "Entitys", null, 2, -1, Link.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
